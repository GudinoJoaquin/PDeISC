...
export default function Contact() {
  ...
  const personalInfo = [
    { label: <IoLogoLinkedin size={24} />, value: "Joaquín Gudiño" },
    { label: <IoLogoGithub size={24} />, value: "Argentina" },
  ];

  return (
    <section id="contact" className=" bg-forest flex items-center justify-center px-4">
      <div
        ref={cardRef}
      ...
      >
        ...
        <div ref={descriptionRef} className="relative">
          <div className="px-4 py-3 rounded-2xl bg-grass/10 backdrop-blur-sm border border-grass/30 hover:bg-grass/20 transition-all duration-300 cursor-pointer group">
            ...
            <textarea className="text-white/90 w-full h-24 text-md text-start leading-relaxed focus:outline-none">
              Escribe un mensaje
            </textarea>
          ...
          <button
            type="submit"
            ref={descriptionRef}
            className="w-full mt-4 bg-grass/20 border border-grass/40 text-white py-3 rounded-xl hover:bg-grass/30 transition-all duration-300"
          >
            Enviar
          </button>
        </div>
